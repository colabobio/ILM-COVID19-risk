...
/* Time: 2020-05-15 19:30:14.741 -0400 */
/* Salt: CE2EFEF8783B000FA0F332FF */
...
#define pop		(__p[__parindex[2]])
#define S_0		(__p[__parindex[3]])
#define E_0		(__p[__parindex[4]])
#define I_0		(__p[__parindex[5]])
#define R_0		(__p[__parindex[6]])
...
#define T_pop		(__pt[__parindex[2]])
#define T_S_0		(__pt[__parindex[3]])
#define T_E_0		(__pt[__parindex[4]])
#define T_I_0		(__pt[__parindex[5]])
#define T_R_0		(__pt[__parindex[6]])
