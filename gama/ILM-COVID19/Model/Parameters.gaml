...
global {
	...
	//string dataset <- "../../Datasets/Manche/"; // default
	...
	string has_preexisting_condition_var <- "HAS_PREEXISTING_CONDITION";// The variable name for "has_preexisting_condition" Individual attribute
