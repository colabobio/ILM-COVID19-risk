---
title: "SEIR parameter estimation with POMP"
output:
  html_document:
    df_print: paged
---

Fits standard SEIR parameters (beta, sigma, gamma) using case counts from GAMA simulations.
...
output_folder <- file.path(main_folder, "output_beta") 
if (!dir.exists(output_folder)) dir.create(output_folder)
cooking_folder <- file.path(main_folder, "output_beta", "bake")
if (!dir.exists(cooking_folder)) dir.create(cooking_folder)
plotting_folder <- file.path(main_folder, "output_beta", "plots")
if (!dir.exists(plotting_folder)) dir.create(plotting_folder)
code_folder <- file.path(main_folder, "code_beta")
...
free_param_names <- c("beta", "sigma", "gamma")
...
log_trans_params <- c("beta", "sigma", "gamma")
...
pair_vars <- ~loglik+beta+sigma+gamma
```
