...
#fixed_param_names <- c("pop", "S_0", "E_0", "I_0", "R_0", "sigma", "gamma", "rho")
#fixed_param_values <- c(pop=pop_size, S_0=1-exp0/pop_size, E_0=exp0/pop_size, I_0=0, R_0=0, sigma=1/6.69, gamma=1/19.21, rho=1.0)
