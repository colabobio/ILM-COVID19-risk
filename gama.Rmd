...
num_filter_iter <- 10    # Number of filtering iterations to perform
num_particles <- 200    # Number of particles to use in filtering.
num_replicates <- 5     # Number of replicated particle filters at each point estimate
